#!/usr/bin/env python3
"""
LightTTice Designer v0.3

A small cell designer for creating patterned-layer JSON files for the RCWA solver.
The exported JSON can be loaded directly by LightTTice Solver.
...
class CellDesigner(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle(f"LightTTice Designer v{APP_VERSION} — unit-cell editor")
