#!/usr/bin/env python3
"""
LightTTice Solver — PyQt5/QtAgg RCWA simulation application for periodic photonic structures.
...
def load_cell_design_json(path):
    """Load a LightTTice Designer cell JSON file."""
...
class RCWAQtGUI(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle(f"LightTTice Solver v{SOLVER_VERSION} — periodic structures")
